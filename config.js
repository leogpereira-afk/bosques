...
window.VERSAO = '52'; // suba a cada publicação, junto com o CACHE do sw.js

// Preview da reconstrução: consulta dados, mas não inicia integração automática.
window.FINANCEIRO_EM_VALIDACAO = false;
