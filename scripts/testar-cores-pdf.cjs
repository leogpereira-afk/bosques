...
roda("PDF.relatorio({rotuloHz:'em 2026',hz:'ano',vendidos:1,vgv:9000,recebido:876.54,gasto:654.32,aReceber:765.43,vencido:4886.25,previsto:432.10,grupos:[],aging:[{rotulo:'1 a 30 dias',rs:1386.25,parcelas:3,contratos:2}]},{})");checa('4.886,25','#b83232');checa('1.386,25','#b83232');checa('765,43','#1d4ed8');
