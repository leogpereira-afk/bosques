...
test('Próxima parcela segue o vencimento após inclusão ou reordenação',()=>{const x=r({...v,parcelas:[{...v.parcelas[0],tid:'futura',venc:'2027-01-01'},v.parcelas[0]]});assert.equal(x.proxima.tid,'p1');});
